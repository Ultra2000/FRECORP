...
<main class="pt-32 pb-20 px-6">
    <div class="max-w-4xl mx-auto relative z-10">
        ...
        <nav class="mb-8 text-sm">
            ...
            <span class="text-white">Conditions Générales de Vente</span>
        </nav>
        ...
        <div class="glass-card rounded-3xl p-8 lg:p-12 space-y-8">
            ...
            <section>
                ...
                <div class="text-slate-400 space-y-3">
                    <p>Les présentes Conditions Générales de Vente (CGV) régissent l'ensemble des prestations payantes fournies par <strong class="text-white">FRECORP</strong> (__STATUT_JURIDIQUE__, __SIREN_OU_SIRET__, __ADRESSE_COMPLETE__), ci-après désigné « le Vendeur », à toute personne physique ou morale procédant à un achat via le site <a href="https://app.frecorp.fr" class="text-indigo-400 hover:underline">https://app.frecorp.fr</a>, ci-après désignée « le Client ».</p>
            ...
            <section>
                ...
                <p class="text-slate-400">FRECORP est un service en ligne (SaaS) d'aide à la gestion d'entreprise comprenant des modules de Point de Vente, gestion de stock, facturation, achats, ressources humaines et comptabilité, accessible par abonnement après création d'un compte.</p>
            </section>
            ...
            <section>
                ...
                <div class="text-slate-400 space-y-3">
                    ...
                    <p>FRECORP propose une <strong class="text-white">période d'essai gratuite d'un mois</strong>, sans engagement, avec accès à l'ensemble des modules.</p>
                    <p>À l'issue de la période d'essai, l'accès devient payant selon les tarifs publiés sur la page Tarifs au moment de la souscription. Le Client est informé par email au moins <strong class="text-white">30 jours avant</strong> la fin de la période d'essai.</p>
            ...
            <section>
                <h2 class="text-2xl font-bold text-white mb-4 flex items-center gap-3">
                    <i class="fas fa-rotate-left text-indigo-400"></i>
                    Article 5 - Droit de rétractation (consommateurs)
                </h2>
                <div class="text-slate-400 space-y-3">
                    <p>Conformément à l'article L221-18 du Code de la consommation, le Client consommateur dispose d'un délai de <strong class="text-white">14 jours</strong> à compter de la souscription pour exercer son droit de rétractation, sans avoir à justifier de motifs ni à payer de pénalités.</p>
                    <p>Pour exercer ce droit, le Client adresse une demande non équivoque à <a href="mailto:contact@frecorp.fr" class="text-indigo-400 hover:underline">contact@frecorp.fr</a>. Le remboursement intervient dans un délai de 14 jours par le même moyen de paiement.</p>
                    <p><strong class="text-white">Renonciation :</strong> conformément à l'article L221-25, le Client peut renoncer expressément à son droit de rétractation pour bénéficier immédiatement du service. Dans ce cas, si le service est exécuté avant la fin du délai de rétractation, le Client devra payer un montant proportionnel à la prestation déjà fournie.</p>
                </div>
            </section>
            ...
            <section>
                ...
                <div class="text-slate-400 space-y-3">
                    ...
                    <p>Avant suppression définitive du compte, le Client dispose d'un délai de <strong class="text-white">30 jours</strong> pour exporter ses données (factures, clients, comptabilité) au format CSV ou PDF, conformément au droit à la portabilité (article 20 RGPD).</p>
            ...
            <section>
                ...
                <div class="text-slate-400 space-y-3">
                    <p>Conformément aux articles L217-3 et suivants du Code de la consommation, le Client consommateur bénéficie de la <strong class="text-white">garantie légale de conformité</strong> et de la garantie contre les <strong class="text-white">vices cachés</strong> (articles 1641 et suivants du Code civil).</p>
                    <p>Pour exercer ces garanties, le Client adresse sa demande motivée à <a href="mailto:contact@frecorp.fr" class="text-indigo-400 hover:underline">contact@frecorp.fr</a>. FRECORP s'engage à apporter une réponse dans un délai de 14 jours.</p>
                </div>
            </section>
            ...
            <section>
                ...
                <p class="text-slate-400">FRECORP s'engage à fournir un service disponible 24h/24, 7j/7, avec un objectif de disponibilité annuel de 99,5 %, hors maintenance programmée annoncée 48 heures à l'avance et hors cas de force majeure (cyberattaque massive, panne d'opérateur, catastrophe naturelle).</p>
            </section>
            ...
            <section>
                ...
                <div class="text-slate-400 space-y-3">
                    ...
                    <p><strong class="text-white">Vis-à-vis des consommateurs :</strong> les présentes limitations ne font pas obstacle à la mise en œuvre des garanties légales et des dispositions impératives du Code de la consommation.</p>
                </div>
            </section>
            ...
            <section>
                ...
                <div class="text-slate-400 space-y-3">
                    ...
                    <div class="bg-slate-800/50 rounded-xl p-4 mt-3">
                        <p><strong class="text-white">__NOM_MEDIATEUR__</strong></p>
                        <p>__ADRESSE_MEDIATEUR__</p>
                        <p>Site : <a href="__URL_MEDIATEUR__" class="text-indigo-400 hover:underline">__URL_MEDIATEUR__</a></p>
                    </div>
                    <p>Le Client peut également recourir à la plateforme européenne de Règlement en Ligne des Litiges : <a href="https://ec.europa.eu/consumers/odr" class="text-indigo-400 hover:underline" target="_blank" rel="noopener">ec.europa.eu/consumers/odr</a></p>
            ...
            <section>
                ...
                <p class="text-slate-400">Les présentes CGV sont soumises au droit français. La langue de référence est le français.</p>
            </section>
            ...
            <section>
                ...
                <p class="text-slate-400">Pour toute question relative aux CGV : <a href="mailto:contact@frecorp.fr" class="text-indigo-400 hover:underline">contact@frecorp.fr</a></p>
            </section>
